...
;(function() {
  ...
  function runInContext(context) {
     ...
     * milliseconds have elapsed since the last limitbuy it was invoked. The created
     ...
     * @param {number} [options.maxWait] The maximum limitbuy `func` is allowed to be delayed before it's called.
